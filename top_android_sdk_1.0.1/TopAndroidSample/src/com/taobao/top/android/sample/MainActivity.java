...
public class MainActivity extends AuthActivity {
	...
	private Long userId;
	private String nick;
	private TopAndroidClient client=TopAndroidClient.getAndroidClientByAppKey("21406151");
...
//						t.show();
        ...
        Button taobaokebtn=(Button)this.findViewById(R.id.button12);
        uploadbtn.setOnClickListener(new OnClickListener(){
        	
        	@Override
        	public void onClick(View arg0) {
        		String ql="select num_iid,title,nick,pic_url,price,click_url,commission,commission_rate,commission_num,commission_volume,shop_click_url,seller_credit_score,item_location,volume from item where num_iid=1500009902569";
        		client.tql(ql, userId, new TopTqlListener(){
